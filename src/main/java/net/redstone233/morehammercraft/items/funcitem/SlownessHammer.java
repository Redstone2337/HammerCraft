...
public class SlownessHammer extends Item {
    private static int ATTACK_DAMAGE_MODIFIER_VALUE = 40;
    private static float ATTACK_SPEED_MODIFIER_VALUE = -0.5F;
    private static final float MINING_SPEED_MULTIPLIER = 6.5F;
    ...
    private static int amplifier = 5;

    public SlownessHammer(Settings settings) {
        super(settings);
    }
    ...
    public static ToolComponent createToolComponent() {
        return new ToolComponent(List.of(), getAttackSpeedModifierValue()+1.0F, 2);
    }
    ...
    public ActionResult useOnEntity(ItemStack stack, PlayerEntity user, LivingEntity entity, Hand hand) {
        if (user != null && hand == Hand.MAIN_HAND){
            entity.addStatusEffect(new StatusEffectInstance(StatusEffects.SLOWNESS,getDuration(),getAmplifier(),true,true,true));
    ...
    public float getBonusAttackDamage(Entity target, float baseAttackDamage, DamageSource damageSource) {
        ...
        return getAttackDamageModifierValue();
    }
    ...
    public static void setAmplifier(int amplifier) {
        SlownessHammer.amplifier = amplifier;
    }

    public static void setDuration(int duration) {
        SlownessHammer.duration = duration;
    }
