...
public class SmallDragonClawItem extends Item {
    ...
    public SmallDragonClawItem(Settings settings) {
        super(settings);
    }
...
//                target.setOnFireFor(150F);
//                spawnLavaSplashParticles(serverWorld,target);
//            }
//            knockbackNearbyEntities(serverWorld, (PlayerEntity) attacker,target);
//        }
//        return true;
//    }
//
